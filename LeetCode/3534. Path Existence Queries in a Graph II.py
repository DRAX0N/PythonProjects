...
if __name__ == "__main__":
    s = Solution()
    print(s.pathExistenceQueries(n = 5, nums = [1,8,3,4,2], maxDiff = 3, queries = [[0,3],[2,4]]))  # Output: [1,1]
    print(s.pathExistenceQueries(n = 5, nums = [5,3,1,9,10], maxDiff = 2, queries = [[0,1],[0,2],[2,3],[4,3]]))  # Output: [1,2,-1,1]