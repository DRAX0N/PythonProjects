...
if __name__ == "__main__":
    ...
    waterStartTime = [6]
    waterDuration = [3]
    print(Solution().earliestFinishTime(landStartTime, landDuration, waterStartTime, waterDuration)) # Output: 9

    landStartTime = [5]
    landDuration = [3]
    waterStartTime = [1]
    waterDuration = [10]
    print(Solution().earliestFinishTime(landStartTime, landDuration, waterStartTime, waterDuration)) # Output: 14